 ...
 * while docker_compose contains all FlexDEV additions (labels, environment variables, networks).
 *
 * These tests verify the fix for the issue where docker_compose_raw was being set to the
 * fully processed compose (with FlexDEV labels, networks, etc.) instead of keeping it clean
