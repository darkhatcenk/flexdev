...
it('can dispatch FlexDEVTask successfully', function () {
    ...
    Queue::assertPushed(FlexDEVTask::class);
});

it('has correct retry configuration on FlexDEVTask', function () {
    $server = Server::where('ip', '!=', '1.2.3.4')->first();
