---
id: task-00001
title: Implement Docker build caching for FlexDEV staging builds
status: To Do
assignee: []
...
2. Update .github/workflows/flexdev-staging-build.yml for AMD64 job:
...
3. Update .github/workflows/flexdev-staging-build.yml for AARCH64 job:
   - Add docker/setup-buildx-action@v3 step after checkout  
   - Configure cache-from and cache-to parameters in build-push-action
