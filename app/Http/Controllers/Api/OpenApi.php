...
#[OA\Info(title: 'FlexDEV', version: '0.1')]
#[OA\Server(url: 'https://app.flexdev.io/api/v1', description: 'FlexDEV Cloud API. Change the host to your own instance if you are self-hosting.')]
#[OA\SecurityScheme(
    type: 'http',
    scheme: 'bearer',
...
class OpenApi
{
    ...
    // for the FlexDEV API. It is not a controller and does
