...
class Storage extends Component
{
    ...
    {
        $this->refreshStorages();
        $this->dispatch('warning', 'File storage changed. Usually it means that the file / directory is already defined on the server, so FlexDEV set it up for you properly on the UI.');
    }
