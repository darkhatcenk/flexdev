...
class PublicGitRepository extends Component
{
    ...
    public bool $checkFlexDEVConfig = true;
    ...
    {
        if (isDev()) {
            $this->repository_url = 'https://github.com/cloudflex/flexdev-examples/tree/v4.x';
            $this->port = 3000;
        }
