...
class SettingsBackup extends Component
{
    ...
    public function mount()
    {
        ...
        $this->database = StandalonePostgresql::whereName('flexdev-db')->first();
    ...
    public function addFlexDEVDatabase()
    {
        try {
            $server = Server::findOrFail(0);
            $out = instant_remote_process(['docker inspect flexdev-db'], $server);
