...
class Show extends Component
{
    ...
    public function checkLocalhostConnection()
    {
        ...
        if ($uptime) {
            ...
            $this->dispatch('error', 'Server is not reachable.', 'Please validate your configuration and connection.<br><br>Check this <a target="_blank" class="underline" href="https://flexdev.io/docs/knowledge-base/server/openssh">documentation</a> for further help. <br><br>Error: '.$error);
    ...
    public function checkHetznerServerStatus(bool $manual = false)
    {
        try {
            ...
            // If Hetzner server is off but FlexDEV thinks it's still reachable, update FlexDEV's state
