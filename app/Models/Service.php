...
#[OA\Schema(
    ...
    properties: [
        ...
        'docker_compose' => ['type' => 'string', 'description' => 'The docker-compose.yml file that is parsed and modified by FlexDEV.'],
...
class Service extends BaseModel
{
    ...
    {
        $server = data_get($this, 'destination.server');
        instant_remote_process(["docker network disconnect {$this->uuid} flexdev-proxy"], $server, false);
    ...
    public function saveComposeConfigs()
    {
        ...
        $envs_from_flexdev = $this->environment_variables()->get();
        $sorted = $envs_from_flexdev->sortBy(function ($env) {
