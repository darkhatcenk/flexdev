...
class ValidateAndInstallServerJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            if (! $uptime) {
                $errorMessage = 'Server is not reachable. Please validate your configuration and connection.<br>Check this <a target="_blank" class="underline" href="https://flexdev.io/docs/knowledge-base/server/openssh">documentation</a> for further help. <br><br>Error: '.$error;
                $this->server->update([
