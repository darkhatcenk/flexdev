...
class CheckAndStartSentinelJob implements ShouldBeEncrypted, ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $sentinelFound = instant_remote_process_with_timeout(['docker inspect flexdev-sentinel'], $this->server, false, 10);
        ...
        $runningVersion = instant_remote_process_with_timeout(['docker exec flexdev-sentinel sh -c "curl http://127.0.0.1:8888/api/version"'], $this->server, false);
