...
use App\Actions\FlexDEVTask\RunRemoteProcess;
...
class FlexDEVTask implements ShouldBeEncrypted, ShouldQueue
{
    ...
    {
        Log::channel('scheduled-errors')->error('FlexDEVTask permanently failed', [
            'job' => 'FlexDEVTask',
