...
class StatusChanged extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $fqdn = $this->fqdn;
        $mail->subject("FlexDEV: {$this->resource_name} has been stopped");
    ...
    public function toDiscord(): DiscordMessage
    {
        return new DiscordMessage(
            ...
            description: '[Open Application in FlexDEV]('.$this->resource_url.')',
    ...
    {
        $message = 'FlexDEV: '.$this->resource_name.' has been stopped.';
