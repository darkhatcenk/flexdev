...
class ServerPatchCheck extends CustomEmailNotification
{
    ...
    public function toMail($notifiable = null): MailMessage
    {
        ...
        if (isset($this->patchData['error'])) {
            $mail->subject("FlexDEV: [ERROR] Failed to check patches on {$this->server->name}");
        ...
        $mail->subject("FlexDEV: [ACTION REQUIRED] {$totalUpdates} server patches available on {$this->server->name}");
    ...
    public function toDiscord(): DiscordMessage
    {
        ...
        if (isset($this->patchData['error'])) {
            ...
            return new DiscordMessage(
                title: ':x: FlexDEV: [ERROR] Failed to check patches on '.$this->server->name,
        ...
        return new DiscordMessage(
            title: ':warning: FlexDEV: [ACTION REQUIRED] Server patches available on '.$this->server->name,
            description: $description,
            color: DiscordMessage::errorColor(),
        );
    ...
    public function toTelegram(): array
    {
        ...
        if (isset($this->patchData['error'])) {
            ...
            $message = "❌ FlexDEV: [ERROR] Failed to check patches on {$this->server->name}!\n\n";
        ...
        $message = "🔧 FlexDEV: [ACTION REQUIRED] {$totalUpdates} server patches available on {$this->server->name}!\n\n";
        $message .= "📊 Summary:\n";
        $message .= '• OS: '.ucfirst($osId)."\n";
        $message .= "• Package Manager: {$packageManager}\n";
    ...
    public function toSlack(): SlackMessage
    {
        ...
        if (isset($this->patchData['error'])) {
            ...
            return new SlackMessage(
                title: 'FlexDEV: [ERROR] Server patch check failed',
                description: $description,
        ...
        return new SlackMessage(
            title: 'FlexDEV: [ACTION REQUIRED] Server patches available',
            description: $description,
            color: SlackMessage::errorColor()
        );
    }
