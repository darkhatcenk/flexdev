...
class DockerCleanupFailed extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("FlexDEV: [ACTION REQUIRED] Docker cleanup job failed on {$this->server->name}");
    ...
    public function toDiscord(): DiscordMessage
    {
        return new DiscordMessage(
            title: ':cross_mark: FlexDEV: [ACTION REQUIRED] Docker cleanup job failed on '.$this->server->name,
    ...
    {
        return [
            'message' => "FlexDEV: [ACTION REQUIRED] Docker cleanup job failed on {$this->server->name}!\n\n{$this->message}",
        ];
    }
    ...
    public function toSlack(): SlackMessage
    {
        return new SlackMessage(
            title: 'FlexDEV: [ACTION REQUIRED] Docker cleanup job failed',
