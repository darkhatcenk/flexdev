...
class HighDiskUsage extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("FlexDEV: Server ({$this->server->name}) high disk usage detected!");
    ...
    public function toDiscord(): DiscordMessage
    {
        ...
        $message->addField('What to do?', '[Link](https://flexdev.io/docs/knowledge-base/server/automated-cleanup)', true);
    ...
    {
        return [
            'message' => "FlexDEV: Server '{$this->server->name}' high disk usage detected!\nDisk usage: {$this->disk_usage}%. Threshold: {$this->server_disk_usage_notification_threshold}%.\nPlease cleanup your disk to prevent data-loss.\nHere are some tips: https://flexdev.io/docs/knowledge-base/server/automated-cleanup.",
        ];
    }
    ...
    public function toPushover(): PushoverMessage
    {
        return new PushoverMessage(
            ...
            buttons: [
                ...
                'Tips for cleanup' => 'https://flexdev.io/docs/knowledge-base/server/automated-cleanup',
            ],
        );
    }
    ...
    public function toSlack(): SlackMessage
    {
        ...
        $description .= "Tips for cleanup: https://flexdev.io/docs/knowledge-base/server/automated-cleanup\n";
