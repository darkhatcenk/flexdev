...
namespace App\Actions\FlexDEVTask;

use App\Data\FlexDEVTaskArgs;
use App\Jobs\FlexDEVTask;
use Spatie\Activitylog\Models\Activity;

/**
 * The initial step to run a `FlexDEVTask`: a remote SSH process
 * with monitoring/tracking/trace feature. Such thing is made
 * possible using an Activity model and some attributes.
 */
class PrepareFlexDEVTask
{
    protected Activity $activity;

    protected FlexDEVTaskArgs $remoteProcessArgs;

    public function __construct(FlexDEVTaskArgs $remoteProcessArgs)
    {
