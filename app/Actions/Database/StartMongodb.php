...
class StartMongodb
{
    ...
    public function handle(StandaloneMongodb $database)
    {
        ...
        if (isDev()) {
            $this->configuration_dir = '/var/lib/docker/volumes/flexdev_dev_flexdev_data/_data/databases/'.$container_name;
        }
        ...
        if ($this->database->enable_ssl) {
            $docker_compose['services'][$container_name]['volumes'] = array_merge(
                ...
                [
                    [
                        'type' => 'bind',
                        'source' => '/data/flexdev/ssl/flexdev-ca.crt',
    ...
    private function generate_environment_variables()
    {
        ...
        add_flexdev_default_environment_variables($this->database, $environment_variables, $environment_variables);
