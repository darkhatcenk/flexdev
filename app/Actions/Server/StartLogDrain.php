...
[FILTER]
    Name                modify
    Match               *
    Set                 flexdev.server_name {$server->name}
    Rename              FLEXDEV_APP_NAME flexdev.app_name
    Rename              FLEXDEV_PROJECT_NAME flexdev.project_name
    Rename              FLEXDEV_SERVER_IP flexdev.server_ip
    Rename              FLEXDEV_ENVIRONMENT_NAME flexdev.environment_name
[OUTPUT]
    Name nrlogs
    Match *
...
services:
  flexdev-log-drain:
    ...
    container_name: flexdev-log-drain
