...
return [
    'flexdev' => [
        ...
        'base_config_path' => env('BASE_CONFIG_PATH', '/data/flexdev'),
        'registry_url' => env('REGISTRY_URL', 'ghcr.io'),
        'helper_image' => env('HELPER_IMAGE', env('REGISTRY_URL', 'ghcr.io').'/cloudflex/flexdev-helper'),
        'realtime_image' => env('REALTIME_IMAGE', env('REGISTRY_URL', 'ghcr.io').'/cloudflex/flexdev-realtime'),
        'is_windows_docker_desktop' => env('IS_WINDOWS_DOCKER_DESKTOP', false),
        'releases_url' => 'https://cdn.flexdev.io/releases.json',
    ],

    'urls' => [
        'docs' => 'https://flexdev.io/docs',
        'contact' => 'https://flexdev.io/docs/contact',
    ],

    'services' => [
        // Temporary disabled until cache is implemented
        // 'official' => 'https://cdn.cloudflex.io/flexdev/service-templates.json',
        'official' => 'https://raw.githubusercontent.com/cloudflex/flexdev/v4.x/templates/service-templates-latest.json',
