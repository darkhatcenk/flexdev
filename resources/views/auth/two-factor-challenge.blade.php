                ...
                <div class="space-y-6">
                    ...
                    <div x-show="!showRecovery"
                        ...
                        <div class="flex gap-3">
                            <svg class="size-5 flex-shrink-0 mt-0.5 text-cloudflex dark:text-warning"
                            ...
                            <div class="flex gap-2 justify-center" @paste="pasteCode($event)">
                                <template x-for="(digit, index) in digits" :key="index">
                                    <input type="text" inputmode="numeric" maxlength="1" x-model="digits[index]"
                                        ...
                                        class="w-12 h-14 text-center text-2xl font-bold bg-white dark:bg-coolgray-100 border-2 border-neutral-200 dark:border-coolgray-300 rounded-lg focus:border-cloudflex dark:focus:border-warning focus:outline-none focus:ring-0 transition-colors"
                                        autocomplete="off" />
                                </template>
                            </div>
                    ...
                    <a href="/login"
                        class="block w-full text-center py-3 px-4 rounded-lg border border-neutral-300 dark:border-coolgray-400 font-medium hover:border-cloudflex dark:hover:border-warning transition-colors">
                        Back to Login
                    </a>
                </div>
            </div>
