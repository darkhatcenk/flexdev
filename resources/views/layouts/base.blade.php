...
<head>
    ...
    <meta name="Description" content="FlexDEV: An open-source & self-hostable Heroku / Netlify / Vercel alternative" />
    <meta name="viewport" content="width=device-width,initial-scale=1" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@flexdevio" />
    <meta name="twitter:title" content="FlexDEV" />
    <meta name="twitter:description" content="An open-source & self-hostable Heroku / Netlify / Vercel alternative." />
    <meta name="twitter:image" content="https://cdn.cloudflex.io/assets/flexdev/og-image.png" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://flexdev.io" />
    <meta property="og:title" content="FlexDEV" />
    <meta property="og:description" content="An open-source & self-hostable Heroku / Netlify / Vercel alternative." />
    <meta property="og:site_name" content="FlexDEV" />
    <meta property="og:image" content="https://cdn.cloudflex.io/assets/flexdev/og-image.png" />
    ...
    @endphp
    <title>{{ $name }}{{ $title ?? 'FlexDEV' }}</title>
    @env('local')
        <link rel="icon" href="{{ asset('flexdev-logo-dev-transparent.png') }}" type="image/png" />
    @else
        <link rel="icon" href="{{ asset('flexdev-logo.svg') }}" type="image/svg+xml" />
    @endenv
    ...
    @if (config('app.name') == 'FlexDEV Cloud')
        <script defer data-domain="app.flexdev.io" src="https://analytics.cloudflex.io/js/plausible.js"></script>
    ...
    <script data-navigate-once>
        ...
        @auth
            ...
            window.Echo = new Echo({
                ...
                key: "{{ config('constants.pusher.app_key') }}" || 'flexdev',
