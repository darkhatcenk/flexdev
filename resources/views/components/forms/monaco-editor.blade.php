<div wire:key="{{ rand() }}" class="flexdev-monaco-editor flex-1">
    <div x-ref="monacoRef" x-data="{
        ...
        monacoEditorAddLoaderScriptToHead() {
            ...
            if (!window.__flexdevMonacoLoaderAdding && typeof _amdLoaderGlobal === 'undefined') {
                window.__flexdevMonacoLoaderAdding = true;
                let script = document.createElement('script');
                script.src = `/js/monaco-editor-${this.monacoVersion}/min/vs/loader.js`;
                script.onload = () => {
                    window.__flexdevMonacoLoaderAdding = false;
                };
                script.onerror = () => {
                    window.__flexdevMonacoLoaderAdding = false;
                };
        ...
        <div x-cloak x-init="if (typeof _amdLoaderGlobal == 'undefined' && !window.__flexdevMonacoLoaderAdding) {
            monacoEditorAddLoaderScriptToHead();
        }
        checkTheme();
