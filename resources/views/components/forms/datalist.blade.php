                ...
                <template x-for="option in filteredOptions" :key="option.value">
                    <div @click="toggleOption(option.value)"
                        ...
                        <input type="checkbox" :checked="isSelected(option.value)"
                            class="w-4 h-4 rounded border-neutral-300 dark:border-neutral-600 bg-white dark:bg-coolgray-100 text-black dark:text-white checked:bg-white dark:checked:bg-coolgray-100 focus:ring-cloudflex dark:focus:ring-warning pointer-events-none"
                            tabindex="-1">
