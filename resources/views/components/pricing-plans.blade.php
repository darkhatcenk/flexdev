    ...
    <div class="px-6 mx-auto lg:px-8">
        <div class="flex justify-center">
            <fieldset
                ...
                <label class="cursor-pointer rounded-sm px-2.5 py-1"
                    :class="selected === 'monthly' ? 'bg-cloudflex-100 text-white' : ''">
                    <input type="radio" x-on:click="selected = 'monthly'" name="frequency" value="monthly"
                        class="sr-only">
                    <span>Monthly</span>
                </label>
                <label class="cursor-pointer rounded-sm px-2.5 py-1"
                    :class="selected === 'yearly' ? 'bg-cloudflex-100 text-white' : ''">
        ...
        <div class="p-4 rounded-sm bg-coolgray-400">
            <h2 id="tier-hobby" class="flex items-start gap-4 text-4xl font-bold tracking-tight">Unlimited Trial
                <x-forms.button><a class="font-bold dark:text-white hover:no-underline"
                        href="https://github.com/cloudflex/flexdev">Get Started</a></x-forms.button>
            </h2>
        ...
        <div class="flow-root mt-12">
            <div class="pb-10 text-xl text-center">For the detailed list of features, please visit our landing page: <a
                    class="font-bold underline dark:text-white" href="https://flexdev.io">flexdev.io</a></div>
            <div
        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-2 gap-y-28">
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    Once you connected your server, FlexDEV will start managing it and do a
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    ...
                    you decide to stop using FlexDEV, you can still continue to manage your
                    deployed resources.
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    FlexDEV will automatically monitor your configured servers and deployed
