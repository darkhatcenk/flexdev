<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Server Resources | FlexDEV
    </x-slot>
    ...
    <div x-data="{ activeTab: 'managed' }" class="flex flex-col h-full gap-8 md:flex-row">
        <div class="w-full">
            <div class="flex flex-col">
                ...
                <div>Here you can find all resources that are managed by FlexDEV.</div>
                <div class="flex flex-row gap-4 py-10">
                    <div @class([
                        ...
                        'dark:bg-cloudflex bg-cloudflex text-white' => $activeTab === 'managed',
                    ...
                    <div @class([
                        'box-without-bg cursor-pointer dark:bg-coolgray-100 dark:text-white w-full text-center items-center justify-center',
                        'dark:bg-cloudflex bg-cloudflex text-white' => $activeTab === 'unmanaged',
