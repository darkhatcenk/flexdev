<div class="w-full">
    ...
    @else
        <form class="flex flex-col w-full gap-2" wire:submit='submit'>
            ...
            <div class="text-xs dark:text-warning text-cloudflex ">Non-root user is experimental: <a
                    class="font-bold underline" target="_blank"
                    href="https://flexdev.io/docs/knowledge-base/server/non-root-user">docs</a>.</div>
