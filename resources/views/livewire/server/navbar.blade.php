            ...
            <div>
                @if ($server->proxySet())
                    @if ($proxyStatus === 'running')
                            ...
                            'All resources hosted on flexdev will be unavailable during the restart.',
                            ...
                            'The flexdev proxy will be stopped.',
                            'All resources hosted on flexdev will be unavailable.',
