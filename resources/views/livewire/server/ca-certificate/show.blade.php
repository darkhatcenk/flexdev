<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > CA Certificate | FlexDEV
    </x-slot>
                    ...
                    <div class="flex gap-2">
                        <x-modal-confirmation title="Confirm changing of CA Certificate?" buttonTitle="Save"
                            submitAction="saveCaCertificate" :actions="[
                                'This will overwrite the existing CA certificate at /data/flexdev/ssl/flexdev-ca.crt with your custom CA certificate.',
                            ...
                            confirmationText="/data/flexdev/ssl/flexdev-ca.crt" shortConfirmationLabel="CA Certificate Path"
                        ...
                        <x-modal-confirmation title="Confirm Regenerate Certificate?" buttonTitle="Regenerate "
                            submitAction="regenerateCaCertificate" :actions="[
                                'This will generate a new CA certificate at /data/flexdev/ssl/flexdev-ca.crt and replace the existing one.',
            ...
            <div class="space-y-4">
                <div class="text-sm">
                    ...
                    <ul class="list-disc pl-5 space-y-1">
                        <li>Mount this CA certificate of FlexDEV into all containers that need to connect to one of
                        ...
                        <li>Read more when and why this is needed <a class="underline dark:text-white"
                                href="https://flexdev.io/docs/databases/ssl" target="_blank">here</a>.</li>
                    </ul>
                </div>
                <div class="relative">
                    <x-forms.copy-button text="- /data/flexdev/ssl/flexdev-ca.crt:/etc/ssl/certs/flexdev-ca.crt:ro" />
                </div>
            </div>
            <div>
