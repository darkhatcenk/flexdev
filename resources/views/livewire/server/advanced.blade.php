<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Advanced | FlexDEV
    </x-slot>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-wrap gap-2 sm:flex-nowrap pt-4">
                        ...
                        <x-forms.input canGate="update" :canResource="$server" id="serverDiskUsageNotificationThreshold"
                            ...
                            helper="If the server disk usage exceeds this threshold, FlexDEV will send a notification to the team members." />
                    </div>
                </div>
