<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Cloudflare Tunnel | FlexDEV
    </x-slot>
            ...
            <div class="flex flex-col gap-2 pt-6">
                ...
                @elseif (!$server->isFunctional())
                    <x-callout type="info" title="Configuration Options" class="mb-4">
                        ...
                        For more information, please read our <a
                            href="https://flexdev.io/docs/knowledge-base/cloudflare/tunnels/server-ssh" target="_blank"
                ...
                @if (!$isCloudflareTunnelsEnabled && $server->isFunctional())
                    <div class="flex  flex-col pb-2">
                        <h3>Automated </h3>
                        <a href="https://flexdev.io/docs/knowledge-base/cloudflare/tunnels/server-ssh" target="_blank"
                        ...
                        @can('update', $server)
                            <form @submit.prevent="$wire.dispatch('automatedCloudflareConfig')"
                                ...
                                <x-forms.input id="ssh_domain" label="Configured SSH Domain" required
                                    helper="The SSH domain you configured in Cloudflare. Make sure there is no protocol like http(s):// so you provide a FQDN not a URL. <a class='underline dark:text-white' href='https://flexdev.io/docs/knowledge-base/cloudflare/tunnels/server-ssh' target='_blank'>Documentation</a>" />
