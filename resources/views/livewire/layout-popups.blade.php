                ...
                if (window.Echo) {
                    if (window.Echo.connector.pusher.connection.state === 'connected') {
                        ...
                        if (checkNumber > 5) {
                            ...
                            console.error(
                                'FlexDEV could not connect to its real-time service. This will cause unusual problems on the UI if not fixed! Please check the related documentation (https://flexdev.io/docs/knowledge-base/cloudflare/tunnels/overview) or get help on Discord (https://cloudflex.io/discord).)'
                            );
                        }
                ...
                <x-popup>
                    ...
                    <x-slot:description>
                        <div>This will cause unusual problems on the
                            ...
                            <a class="underline" href='https://flexdev.io/docs/knowledge-base/server/firewall'
                                target='_blank'>required ports</a> or get
                            help on <a class="underline" href='https://cloudflex.io/discord' target='_blank'>Discord</a>.
                        </div>
                    </x-slot:description>
                ...
                <x-slot:customActions>
                    <div
                        ...
                        <div class="flex flex-col gap-2 lg:px-10 px-1">
                            <div class="lg:text-xl text-md dark:text-white font-bold">Love FlexDEV? Support our work.
                            </div>
                        ...
                        <div class="flex flex-col gap-2 text-center md:mx-auto lg:py-0 pt-2">
                            <x-forms.button isHighlighted class="md:w-36 w-full"><a target="_blank"
                                    href="https://github.com/sponsors/cloudflex"
                                    class="font-bold dark:text-white">GitHub
                                    Sponsors</a></x-forms.button>
                            <x-forms.button isHighlighted class="md:w-36 w-full"><a target="_blank"
                                    href="https://opencollective.com/cloudflex/donate?interval=month&amount=10&name=&legalName=&email="
