                                ...
                                @if ($existingResources > 0)
                                    ...
                                    @foreach ($searchResults as $result)
                                        @if (!isset($result['is_creatable_suggestion']))
                                            <a href="{{ $result['link'] ?? '#' }}"
                                                class="search-result-item block px-4 py-3 hover:bg-neutral-50 dark:hover:bg-coolgray-200 transition-colors focus:outline-none focus:bg-yellow-50 dark:focus:bg-yellow-900/20 border-transparent hover:border-cloudflex focus:border-yellow-500 dark:focus:border-yellow-400">
                ...
                <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen" x-transition:enter="ease-out duration-100"
                    ...
                    <div class="flex items-center justify-between pb-3">
                        ...
                        <button @click="modalOpen=false"
                            class="absolute top-0 right-0 flex items-center justify-center w-8 h-8 mt-5 mr-5 rounded-full dark:text-white hover:bg-neutral-100 dark:hover:bg-coolgray-300 outline-0 focus-visible:ring-2 focus-visible:ring-cloudflex dark:focus-visible:ring-warning">
