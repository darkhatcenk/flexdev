<div class="flex flex-col gap-4">
    @if (
        ...
        @if ($resource?->build_pack === 'dockercompose')
            <div class="dark:text-warning text-cloudflex">Please modify storage layout in your Docker Compose
