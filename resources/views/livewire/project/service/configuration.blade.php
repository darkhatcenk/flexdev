<div>
    <x-slot:title>
        {{ data_get_str($service, 'name')->limit(10) }} > Configuration | FlexDEV
    </x-slot>
    ...
    <div class="flex flex-col h-full gap-8 sm:flex-row">
        ...
        <div class="w-full">
                                                    ...
                                                    <x-slot:content>
                                                        <span class="cursor-pointer">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="w-4 h-4 dark:text-warning text-cloudflex"
                                                                viewBox="0 0 24 24">
            ...
            @elseif ($currentRoute === 'project.service.storages')
                ...
                <div class="pb-4 dark:text-warning text-cloudflex">If you would like to add a volume, you must add it to
