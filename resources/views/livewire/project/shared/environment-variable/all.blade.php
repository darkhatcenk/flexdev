<div class="flex flex-col gap-4">
    <div>
        ...
        @if ($resource->type() === 'service' || $resource?->build_pack === 'dockercompose')
            <div class="flex items-center gap-1 pt-4 dark:text-warning text-cloudflex">
            ...
            {{-- <div class="pb-4 dark:text-warning text-cloudflex">If you would like to add a variable, you must add it to
