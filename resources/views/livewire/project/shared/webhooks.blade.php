<div class="flex flex-col gap-2">
    <div class="flex items-center gap-2">
        <h2>Webhooks</h2>
        <x-helper
            helper="For more details goto our <a class='underline dark:text-white' href='https://flexdev.io/docs/api/operations/deploy-by-tag-or-uuid' target='_blank'>docs</a>." />
    </div>
    <div>
        <x-forms.input readonly
            helper="See details in our <a target='_blank' class='underline dark:text-white' href='https://flexdev.io/docs/api/operations/deploy-by-tag-or-uuid'>documentation</a>."
