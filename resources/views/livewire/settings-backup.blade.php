<div>
    ...
    <div class="flex flex-col">
        ...
        <div class="pb-4">Backup configuration for FlexDEV instance.</div>
        <div>
            @if ($server->isFunctional())
                ...
                @else
                    To configure automatic backup for your FlexDEV instance, you first need to add a database resource
                    into FlexDEV.
                    <x-forms.button class="mt-2" wire:click="addFlexDEVDatabase">Configure Backup</x-forms.button>
                @endif
            @else
