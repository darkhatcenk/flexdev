        ...
        <div class="flex flex-col items-center w-full space-y-8">
                ...
                <div class="w-full max-w-2xl text-center space-y-8">
                    ...
                    <div class="flex flex-col items-center gap-3 pt-4">
                        ...
                        <button wire:click="skipBoarding"
                            class="text-sm dark:text-neutral-400 hover:text-cloudflex dark:hover:text-warning hover:underline transition-colors">
                            Skip Setup
                        </button>
                    </div>
                </div>
            @elseif ($currentState === 'explanation')
                ...
                <x-boarding-step title="Platform Overview">
                    <x-slot:question>
                        FlexDEV automates deployment and infrastructure management on your own servers. Deploy applications
                        from Git, manage databases, and monitor everything—without vendor lock-in.
                    </x-slot:question>
                    <x-slot:explanation>
                        <p>
                            <x-highlighted text="Automation:" /> FlexDEV handles server configuration, Docker management,
                            and
                ...
                <x-boarding-step title="Choose Server Type">
                    ...
                    <x-slot:actions>
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 w-full">
                            <button
                                class="group relative box-without-bg cursor-pointer hover:border-cloudflex transition-all duration-200 p-6"
                                ...
                                <div class="flex flex-col gap-4 text-left">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm dark:text-neutral-400">
                                            Deploy on the server running FlexDEV. Best for testing and single-server setups.
                                        </p>
                                    </div>
                                </div>
                            </button>
                            ...
                            <button
                                ...
                                <div class="flex flex-col gap-4 text-left">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span
                                            class="px-2 py-1 text-xs font-bold uppercase tracking-wide bg-cloudflex/10 dark:bg-warning/20 text-cloudflex dark:text-warning rounded">
                                            Recommended
                                        </span>
                                    </div>
                                    <div>
                            ...
                            @can('viewAny', App\Models\CloudProviderToken::class)
                                @if ($currentState === 'select-server-type')
                                    <x-modal-input title="Connect a Hetzner Server" isFullWidth>
                                        <x-slot:content>
                                            <div
                                                class="group relative box-without-bg cursor-pointer hover:border-cloudflex transition-all duration-200 p-6 h-full min-h-[210px]">
                                                <div class="flex flex-col gap-4 text-left">
                                                    <div class="flex items-center justify-between">
                            ...
                            <div class="mt-6 p-4 border border-error rounded-lg text-gray-800 dark:text-gray-200">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs mt-1">
                                            ...
                                            <a class="font-bold underline" target="_blank"
                                                href="https://flexdev.io/docs/knowledge-base/server/non-root-user">docs</a>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <ul class="list-disc list-inside">
                                        ...
                                        <li>Or skip the boarding process and manually add a new private key to FlexDEV and
                                            the server</li>
                                    </ul>
                                </div>
                                ...
                                <p class="mb-4">
                                    For more help, check this <a target="_blank" class="underline font-semibold"
                                        href="https://flexdev.io/docs/knowledge-base/server/openssh">documentation</a>.
                                </p>
                    ...
                    <x-slot:explanation>
                        ...
                        <p>
                            <x-highlighted text="Localhost:" /> The machine running FlexDEV. Not recommended for production
                ...
                <x-boarding-step title="SSH Authentication">
                    ...
                    <x-slot:actions>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full">
                            <x-forms.button
                                class="justify-center h-auto py-6 box-without-bg hover:border-cloudflex transition-all duration-200"
                    ...
                    <x-slot:explanation>
                        ...
                        <p>
                            <x-highlighted text="Key Generation:" /> FlexDEV generates ED25519 keys by default for optimal
            ...
            @elseif ($currentState === 'create-private-key')
                ...
                <x-boarding-step title="SSH Key Configuration">
                    ...
                    <x-slot:explanation>
                        <p>
                            <x-highlighted text="Key Storage:" /> Private keys are encrypted at rest in FlexDEV's database.
                        </p>
                        <p>
                                ...
                                <div x-show="showAdvanced" x-cloak
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs dark:text-white text-black">
                                            ...
                                            <a class="font-bold underline hover:text-cloudflex" target="_blank"
                                                href="https://flexdev.io/docs/knowledge-base/server/non-root-user">Learn
                                                more</a>
                                        </p>
                                    </div>
                                </div>
            ...
            @elseif ($currentState === 'validate-server')
                ...
                <x-boarding-step title="Server Validation">
                    <x-slot:question>
                        FlexDEV will automatically install Docker {{ $minDockerVersion }}+ if not present.
                    </x-slot:question>
                    <x-slot:actions>
                    ...
                    <x-slot:explanation>
                        <p>
                            <x-highlighted text="Automated Setup:" /> FlexDEV installs Docker Engine, Docker Compose, and
                        ...
                        <p>
                            ...
                            required.
                            <a target="_blank" class="underline hover:text-cloudflex"
        ...
        @if ($currentState !== 'welcome' && $currentState !== 'create-resource')
            <div class="flex flex-col items-center gap-4 pt-8 mt-8 border-t border-neutral-200 dark:border-coolgray-400">
                <div class="flex justify-center gap-6 text-sm">
                    <button wire:click='skipBoarding'
                        class="dark:text-neutral-400 hover:text-cloudflex dark:hover:text-warning hover:underline transition-colors">
                        Skip Setup
                    </button>
