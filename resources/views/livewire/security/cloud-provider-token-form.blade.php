        ...
        @if ($modal_mode)
            ...
            @if (auth()->user()->currentTeam()->cloudProviderTokens->where('provider', $provider)->isEmpty())
                <div class="text-sm text-neutral-500 dark:text-neutral-400">
                    ...
                    @if ($provider === 'hetzner')
                        <br><br>
                        Don't have a Hetzner account? <a href='https://flexdev.io/hetzner' target='_blank'
                            class='underline dark:text-white'>Sign up here</a>
                        <br>
                        <span class="text-xs">(FlexDEV's affiliate link, only new accounts - supports us (€10)
