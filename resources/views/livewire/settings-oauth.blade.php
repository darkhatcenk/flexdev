                ...
                <div class="p-4 border dark:border-coolgray-300 border-neutral-200">
                    ...
                    <div class="flex flex-col w-full gap-2 xl:flex-row">
                        ...
                        @if ($oauth_setting['provider'] == 'google')
                            <x-forms.input id="oauth_settings_map.{{ $oauth_setting['provider'] }}.tenant"
                                helper="Optional parameter that supplies a hosted domain (HD) to Google, which<br>triggers a login hint to be displayed on the OAuth screen with this domain.<br><br><a class='underline dark:text-warning text-cloudflex' href='https://developers.google.com/identity/openid-connect/openid-connect#hd-param' target='_blank'>Google Documentation</a>"
                                label="Tenant" />
                        @endif
                        @if (
