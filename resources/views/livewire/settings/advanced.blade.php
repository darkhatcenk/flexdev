    ...
    <x-slot:title>
        ...
        <div x-data="{ activeTab: window.location.hash ? window.location.hash.substring(1) : 'general' }"
            ...
            <form wire:submit='submit' class="flex flex-col w-full">
                ...
                <div class="pb-4">Advanced settings for your FlexDEV instance.</div>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="do_not_track"
                            helper="If enabled, FlexDEV will not track any data. This is useful if you are concerned about privacy."
                            label="Do Not Track" />
                    </div>
                    <h4 class="pt-4">DNS Settings</h4>
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_dns_validation_enabled"
                            helper="If you set a custom domain, FlexDEV will validate the domain in your DNS provider."
