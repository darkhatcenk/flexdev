                    ...
                    <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen" x-transition:enter="ease-out duration-100"
                        ...
                        <div class="relative w-auto pb-8">
                            ...
                            <p>You can review the changelogs <a class="font-bold underline dark:text-white"
                                    href="https://github.com/cloudflex/flexdev/releases" target="_blank">here</a>.</p>
                            <br />
                            <p>If something goes wrong and you cannot upgrade your instance, You can check the following
                                <a class="font-bold underline dark:text-white" href="https://flexdev.io/docs/upgrade"
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('upgradeModal', () => ({
                ...
                checkHealthInterval = setInterval(() => {
                    fetch('/api/health')
                        .then(response => {
                            if (response.ok) {
                                this.currentStatus =
                                    'FlexDEV is back online. Reloading this page (you can manually reload if its not done automatically)...';
                                ...
                                this.currentStatus =
                                    "Waiting for FlexDEV to come back from the dead..."
                            }
                        })
                }, 2000);
            },
            upgrade() {
                ...
                this.currentStatus = 'Pulling new images and updating FlexDEV.';
                    ...
                    fetch('/api/health')
                        .then(response => {
                            if (response.ok) {
                                ...
                                this.currentStatus =
                                    "Update done, restarting FlexDEV & waiting until it is revived!"
