<div>
    ...
    <div class="flex flex-wrap gap-2 ">
        @forelse ($tags as $oneTag)
            <a :class="{{ $tag?->id == $oneTag->id }} && 'dark:bg-cloudflex'"
                class="min-w-32 box-without-bg dark:bg-coolgray-100 dark:text-white font-bold dark:hover:bg-cloudflex-100 flex justify-center items-center"
