# FlexDEV AI Documentation

Welcome to the FlexDEV AI documentation hub. This directory contains all AI assistant instructions organized by topic for easy navigation and maintenance.

## Quick Start

- **For Claude Code**: Start with [CLAUDE.md in root directory](../CLAUDE.md)
- **For Cursor IDE**: Check `.cursor/rules/flexdev-ai-docs.mdc` which references this directory
...
- **[Project Overview](core/project-overview.md)** - What FlexDEV is and how it works
- **[Application Architecture](core/application-architecture.md)** - System design and component relationships
- **[Deployment Architecture](core/deployment-architecture.md)** - How deployments work end-to-end, including FlexDEV Docker Compose extensions (custom fields)
...
- Command: `docker exec flexdev php artisan test`
...
→ [core/deployment-architecture.md](core/deployment-architecture.md#flexdev-docker-compose-extensions)
...
- Feature tests: `docker exec flexdev php artisan test` (requires database, inside Docker)
...
- **Cursor IDE users**: Check `.cursor/rules/flexdev-ai-docs.mdc`
