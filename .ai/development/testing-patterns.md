# FlexDEV Testing Architecture & Patterns
...
FlexDEV employs **comprehensive testing strategies** using modern PHP testing frameworks to ensure reliability of deployment operations, infrastructure management, and user interactions.
...
- **MUST** run inside Docker container: `docker exec flexdev php artisan test`
