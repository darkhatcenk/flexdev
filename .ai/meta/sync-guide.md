...
This document explains how AI instructions are organized and synchronized across different AI tools used with FlexDEV.

## Overview

FlexDEV maintains AI instructions with a **single source of truth** approach:

1. **CLAUDE.md** - Main entry point for Claude Code (references `.ai/` directory)
2. **.cursor/rules/flexdev-ai-docs.mdc** - Master reference file for Cursor IDE (references `.ai/` directory)
...
### .cursor/rules/flexdev-ai-docs.mdc
...
- **Structure**:
  ...
  ```
- **Used by**: All AI tools through CLAUDE.md or flexdev-ai-docs.mdc
...
- **.cursor/rules/flexdev-ai-docs.mdc** → references `.ai/` files for detailed documentation
...
3. Verify `.cursor/rules/flexdev-ai-docs.mdc` references are correct
...
- [ ] Verify `.cursor/rules/flexdev-ai-docs.mdc` references are still accurate
...
├── .cursor/
│   └── rules/
│       └── flexdev-ai-docs.mdc        # Cursor IDE master reference
...
- ✅ Replaced 11 .cursor/rules/*.mdc files with single flexdev-ai-docs.mdc
...
grep -r "Laravel 12" .ai/ CLAUDE.md .cursor/rules/flexdev-ai-docs.mdc
grep -r "PHP 8.4" .ai/ CLAUDE.md .cursor/rules/flexdev-ai-docs.mdc
...
5. **Verify `.cursor/rules/flexdev-ai-docs.mdc`** still references correctly
...
When in doubt, prefer detailed documentation in `.ai/` and lightweight references in CLAUDE.md and flexdev-ai-docs.mdc.
